...
IFS=$'\n' combinations=($(awk -F"," 'NR > 1 {print $1,$2,$3,$4}' /home/dream-orin4/LSTM/rerun.csv))
...
for combo in "${combinations[@]}"; do
    ...
    python3 LSTM_logger.py "/home/dream-orin4/LSTM" $no_workers $prefetch_factor $external_device $batch_size > log_file_$batch_size
    sudo pkill python
