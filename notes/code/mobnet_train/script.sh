...
cpu_cores_values=(2 4 6 8 10 12)
cpu_frq_values=(1190400)
gpu_frq_values=(114750000)
...
mem_frq_values=(204000000 2133000000 3199000000 665600000)
#completed 2201 2112 1958 1804 1651 1497 1344 1190(missing) 1036 883 729 576 422 226
    ...
    for gpu_frq in "${gpu_frq_values[@]}"; do
        for cpu_cores in "${cpu_cores_values[@]}"; do
            for mem_frq in "${mem_frq_values[@]}"; do
                ...
                python3 mobnet.py "/media/ssd/data" $no_workers $prefetch_factor $external_device > train_log_file_pm_14
                sudo pkill python
