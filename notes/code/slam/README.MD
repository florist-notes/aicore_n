...
$$  \begin{bmatrix} x_1 \\[0.3em] x_2 \\[0.3em] θ \\[0.3em] \end{bmatrix}_k  $$ 

equals  

$$  \begin{bmatrix} x_1 \\[0.3em] x_2 \\[0.3em] θ \\[0.3em] \end{bmatrix}_{k-1} + \begin{bmatrix} \Delta x_1 \\[0.3em] \Delta x_2 \\[0.3em] \Delta θ \\[0.3em] \end{bmatrix}_k + W_k  $$
